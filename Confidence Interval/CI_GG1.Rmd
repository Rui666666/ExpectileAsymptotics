...
M/M/1
```{r}
sim_mm1 = function(n, omega = 1, rho = 0.9)
{
  # Generate Bernoulli
  B = rbinom(n, 1, rho)
  # Generate exponential
  X = rexp(n, omega*(1-rho))
  # Generate steady-state random numbers of MM1
  mm1 = B*X
  # Return results
  return(mm1)
}
...
Empirical coverage probabilities for M/M/1
```{r}
